...
SYSTEM_INSTRUCTION = (
    ...
    "reply in English. You must only respond in English or Indonesian (for both text and audio). "
    "Never respond in any other language or script. If the detected language is unclear or mixed, "
    "default to English. Prefer spoken responses that are 1-2 short sentences unless "
