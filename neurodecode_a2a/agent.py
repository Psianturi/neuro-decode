...
from tools.clinical import find_local_resources
...
_AGENT_INSTRUCTION = (
    ...
    "1. find_local_resources — find clinics, therapists, schools, hospitals in a city\n"
...
root_agent = Agent(
    ...
    description=(
        "ASD caregiver support agent — finds local ASD resources in Jakarta, "
